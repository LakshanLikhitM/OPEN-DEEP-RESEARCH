...
GROQ_KEY = "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"
TAVILY_KEY = "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"
...
def searcher_agent(state: AgentState) -> AgentState:
    ...
    for task in state["plan"]:
        result = tavily.search(query=task, search_depth="advanced", max_results=3)
        for item in result.get("results", []):
            research.append(f"Source: {item['title']}\nContent: {item['content']}\n")
